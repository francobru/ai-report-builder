...
def render():
    ...
    masthead("Reporte Plan M\u00e9dico",
             "Gesti\u00f3n, eficiencia y productividad de las habilidades de Plan M\u00e9dico")

    # ---------------- Step 1: files ----------------
    ha_step(1, "Subir los archivos")
    ...
    # ---------------- Step 2: indicators ----------------
    ha_step(2, "Revisar los indicadores")
